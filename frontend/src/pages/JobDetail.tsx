  ...
  return (
    <div className="pt-24 pb-24">
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <motion.button
                  ...
                  className="p-2 hover:bg-[rgba(11,16,32,0.5)] rounded-lg transition-colors"
              ...
              >
                ...
                <div className="space-y-4">
                  {job.result.faqs.map((faq, idx) => (
                    <div
                      key={idx}
                      className="p-4 bg-[rgba(11,16,32,0.3)] dark:bg-[rgba(11,16,32,0.3)] rounded-xl border border-[rgba(11,16,32,0.2)]"
                    >
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <motion.button
                    ...
                    className="flex items-center space-x-2 px-3 py-1 bg-[rgba(11,16,32,0.5)] hover:bg-[rgba(11,16,32,0.7)] rounded-lg text-sm text-slate-200 transition-colors"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                ...
                <div
                  ...
                  className="bg-[rgba(11,16,32,0.5)] dark:bg-[rgba(11,16,32,0.5)] rounded-xl p-4 min-h-[200px] overflow-x-auto"
                />
        ...
        {/* Action Bar */}
        <motion.div
          className="fixed bottom-0 left-0 right-0 bg-[rgba(11,16,32,0.9)] dark:bg-[rgba(11,16,32,0.9)] backdrop-blur-md border-t border-[rgba(11,16,32,0.2)] p-4 lg:sticky lg:bottom-auto lg:mt-6 lg:rounded-xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center gap-4">
            <motion.button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-[rgba(11,16,32,0.5)] hover:bg-[rgba(11,16,32,0.7)] rounded-xl text-slate-200 font-medium transition-colors"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
